...
public class SwaggerConfig {
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
				.title("api_blogPessoal")
				.description("Projeto api spring - blogPessoal")
				.version("1.0.0")
				.license("apache license version 2.0")
				.licenseUrl("https://github.com/Renomariocosme/blogPessoal")
				.contact(contact())
				.build();
	}
	private static Contact contact() {
		return new Contact("Renomário Cosme", 
				"https://github.com/Renomariocosme",
				"renomario.cosme@gmail.com");
	}
